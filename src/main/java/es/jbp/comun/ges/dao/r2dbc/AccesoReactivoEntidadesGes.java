...
/**
 * Representa la clase Dao para acceder al repositorio de entidades genericas.
 *
 * @author Jorge
 */
public class AccesoReactivoEntidadesGes extends Dao {
    ...
    public AccesoReactivoEntidadesGes(ConsultaGes consulta, GestorConexiones gestorConexiones, GestorSimbolos gestorSimbolos) {
